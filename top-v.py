...
def train_model(model, anainfo, model_path, model_name, num_sample=50, num_epochs=100000, TOL=1E-7, lr=0.001, alw=True):
    model.train()
...
if __name__ == '__main__':
    ...
    Time = {}
    k = 200
    anainfo = {"E": 2e8, "I": 2.8179e-4, "A": 2.275e-2, "L": 25, "k1": k, "k2": k, "Fx1": 0, "Fy1": 150, "M1": 0}
    numLayer = 3
    numNeuron = 50
    ...
    excel_path = model_path + "\\date.e-7.xlsx"
