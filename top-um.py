...
def train_model(model, anainfo, model_path, model_name, num_sample=50, num_epochs=10000, TOL=1E-7, lr=0.001, alw=True):
    model.train()
    ...
    for epoch in pbar:
        ...
        # 桩顶有竖向约束  L5 = N_Tu*loss(U_S1, Cond5) / (torch.norm(U_S1, p=2) / num_sample)
...
if __name__ == '__main__':
    ...
    Time = {}
    k = 200
    anainfo = {"E": 2e8, "I": 2.8179e-4, "A": 2.275e-2, "L": 25, "k1": k, "k2": k, "Fx1": -800, "Fy1": 0, "M1": 300}
    numLayer = 3
    numNeuron = 50
    ...
    excel_path = model_path + "\\归一化date.e-7.xlsx"
